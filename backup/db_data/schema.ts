import { boolean, int, mysqlEnum, mysqlTable, text, timestamp, varchar, json, decimal, uniqueIndex, index, mediumtext } from "drizzle-orm/mysql-core";
...
export const strategyPerformance = mysqlTable("strategyPerformance", {
  ...
  sharpeRatio: varchar({ length: 50 }), // Risk-adjusted return
  profitFactor: varchar({ length: 50 }), // Gross profit / gross loss
