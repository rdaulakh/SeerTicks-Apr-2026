...
CREATE INDEX `idx_journal_user` ON `tradeJournalEntries` (`userId`);--> statement-breakpoint
CREATE INDEX `idx_journal_trade` ON `tradeJournalEntries` (`tradeId`);--> statement-breakpoint
CREATE INDEX `idx_journal_strategy` ON `tradeJournalEntries` (`strategy`);